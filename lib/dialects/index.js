...
exports.mysql = {
  ...
  isUnique: function(record) {
    return (
      _.isObject(record) &&
      _.has(record, "column_key") &&
      record.column_key.toUpperCase() === "UNI"
    );
  },
  /**
   * Determines if record entry from the getForeignKeysQuery
...
exports.postgres = {
  ...
  isForeignKey: function(record) {
    return (
      _.isObject(record) && _.has(record, "contype") && record.contype === "f"
    );
  },
  /**
   * Determines if record entry from the getForeignKeysQuery
  ...
  isUnique: function(record) {
    return (
      _.isObject(record) && _.has(record, "contype") && record.contype === "u"
    );
  },
  /**
   * Determines if record entry from the getForeignKeysQuery
  ...
  isPrimaryKey: function(record) {
    return (
      _.isObject(record) && _.has(record, "contype") && record.contype === "p"
    );
  },
  /**
   * Determines if record entry from the getForeignKeysQuery
...
exports.mssql = {
  ...
  isSerialKey: function(record) {
    return (
      _.isObject(record) &&
      exports.mssql.isPrimaryKey(record) &&
      (_.has(record, "is_identity") && record.is_identity)
    );
  }
};
